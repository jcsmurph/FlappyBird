...
public class FlappyBird implements ActionListener, MouseListener, KeyListener {
	...
	public void repaint(Graphics g) {
		...
		if (!gameOver && started) {
			...
			g.drawString("High Score", WIDTH / 2  - 600, 50);
			g.drawString(String.valueOf(highScore), WIDTH / 2  - 500, 100);
